...
<section class="features py-50 position-relative overflow-hidden">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center wow slideInUp">
                <h2 class="fw-bolder ff-first text-white mb-4 fs-2">How <span class="text-web-secondary">Khodiyar</span>
                    Drive Works</h2>
            </div>
            <div class="features-main-content col-12 d-flex overflow-x-scroll flex-nowrap py-3 overflow-y-visible">
                <div class="features-p-box col-12 col-lg-4 col-md-6 px-3 pb-5 wow slideInUp">
                    <div class="features-box rounded-2 p-4 bg-white shadow position-relative h-100">
                        ...
                        <h5 class="mb-3 text-web-secondary fw-bold fs-4 text-center">Sign Up</h5>
                        <p class="text-gray ws-2 ff-second fs-6 text-center fw-medium">Upload your documents</p>
                    </div>
                </div>
                <div class="features-p-box col-12 col-lg-4 col-md-6 px-3 pb-5 wow slideInUp">
                    <div class="features-box rounded-2 p-4 bg-white shadow position-relative h-100">
                        ...
                        <h5 class="mb-3 text-web-secondary fw-bold fs-4 text-center">Book Now</h5>
                        <p class="text-gray ws-2 ff-second fs-6 text-center fw-medium">Search for and book a car on our
                            site!</p>
                    </div>
                </div>
                <div class="features-p-box col-12 col-lg-4 col-md-6 px-3 pb-5 wow slideInUp">
                    <div class="features-box rounded-2 p-4 bg-white shadow position-relative h-100">
                        ...
                        <h5 class="mb-3 text-web-secondary fw-bold fs-4 text-center">Unlock</h5>
                        <p class="text-gray ws-2 ff-second fs-6 text-center fw-medium">We SMS your car details 20
                ...
                <div class="features-p-box col-12 col-lg-4 col-md-6 px-3 pb-5 wow slideInUp">
                    <div class="features-box rounded-2 p-4 bg-white shadow position-relative h-100">
                        ...
                        <h5 class="mb-3 text-web-secondary fw-bold fs-4 text-center">Just Drive</h5>
                        <p class="text-gray ws-2 ff-second fs-6 text-center fw-medium">Enjoy your ride</p>
                    </div>
                </div>
                <div class="features-p-box col-12 col-lg-4 col-md-6 px-3 pb-5 wow slideInUp">
                    <div class="features-box rounded-2 p-4 bg-white shadow position-relative h-100">
                        <div class="features-imgs text-center justify-content-center d-flex mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                ...
                                class="hovered-paths">
                                <g>
                                    <linearGradient id="a" x1="0" x2="512" y1="256" y2="256"
                                        gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#fbb03b"></stop>
                                        <stop offset="1" stop-color="#f15a24"></stop>
                                    </linearGradient>
                                    <path fill="url(#a)"
                                        d="M413.81 0H98.19C44.05 0 0 44.05 0 98.19v315.62C0 467.95 44.05 512 98.19 512h315.62c54.14 0 98.19-44.05 98.19-98.19V98.19C512 44.05 467.95 0 413.81 0zm-62.17 372.18H96.78c-11.04 0-20-8.95-20-20 0-11.04 8.96-20 20-20h254.86c31.04 0 56.29-25.25 56.29-56.28 0-31.04-25.25-56.29-56.29-56.29H132.36l4.5 4.5c7.81 7.81 7.81 20.48 0 28.29-3.9 3.9-9.02 5.85-14.14 5.85s-10.24-1.95-14.14-5.85l-38.65-38.65c-7.81-7.81-7.81-20.47 0-28.28l39.79-39.8c7.811-7.81 20.48-7.81 28.29 0 7.81 7.82 7.81 20.48 0 28.29l-5.65 5.65h219.28c53.09 0 96.29 43.19 96.29 96.29 0 53.09-43.2 96.28-96.29 96.28z"
                                        opacity="1" data-original="url(#a)" class="hovered-path"></path>
                                </g>
                            </svg>
                        </div>
                        <h5 class="mb-3 text-web-secondary fw-bold fs-4 text-center">Return</h5>
                        <p class="text-gray ws-2 ff-second fs-6 text-center fw-medium">Return the car to pickup location
                            and fill the end.</p>
                    </div>
                </div>
            </div>
...
<section class="services py-80 position-relative bg-light overflow-hidden">
    <div class="service-img position-absolute top-0 start-0 w-100 h-100">
        <img src="https://madhavtechinfo.000webhostapp.com/assets/img/services.png" alt="" class="w-100">
    </div>
    <div class="container z-2 position-relative">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-xl-3 mt-5 pt-5">
                <div class="services-box h-100 bg-white py-80 pb-5 px-4 text-center shadow position-relative">
            ...
            <div class="col-12 col-md-6 col-xl-3 mt-5 pt-5">
                <div class="services-box h-100 bg-white py-80 pb-5 px-4 text-center shadow position-relative">
                    <div class="services-icon-box p-4 shadow rounded-5 position-absolute top-0 start-50">
                        <img src="https://madhavtechinfo.000webhostapp.com/assets/img/ig-4.svg" alt="svg" class="w-100">
                    </div>
                    <h3 class="fw-bolder fs-5 mb-3 pb-3 ff-first position-relative">Tariff Per Hour</h3>
                    <p class="fs-14 text-gray ff-second overflow-y-scroll scroll-none">Flexible per hour tariff.</p>
                </div>
            </div>
        </div>
    </div>
